...
const DulcesCard = () => {
    return (
        <div className="min-h-[90vh] flex items-center justify-center border-amber-600" >
            <div className=" w-[85%] h-[70vh] relative bg-linear-to-r from-yellow-950/50 via-yellow-200/60  to-yellow-950/50 backdrop-blur-lg rounded-lg shadow-lg">
                ...
                <div className="descrip-imagen grid grid-cols-[60%_40%] place-items-center border-red-500 w-full">
                    <div className="descripcion p-4">
                        <p className="font-nunito text-shadow-md text-blue-950 text-xl">
